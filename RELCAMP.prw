...
(SELECT SE1.E1_NUM || '-' || SE1.E1_PARCELA || ' Vencto: ' || TO_CHAR( TO_DATE(SE1.E1_VENCREA, 'YYYY/MM/DD'), 'DD/MM/YYYY') || CASE WHEN LENGTH(TRIM(SE1.E1_BAIXA)) IS NULL THEN ' EM ABERTO' ELSE ' BAIXADO' END
...
LEFT JOIN SB1010 SB1 ON SC6.C6_PRODUTO = SB1.B1_COD  AND SB1.D_E_L_E_T_ <> '*' 
